...
jQuery(document).ready(function($) { 
    ...
    tinymce.PluginManager.add('keyup_events', function(editor, url) { 
    ...
    function do_stuff_here(id,content) {
		...
		{
			case 'desc':
				$('#cc-pu-customize-preview-'+target[1]+' .modal-inner-caption').html(content);
			break;
			
			case 'video':
				$('#cc-pu-customize-preview-'+target[1]+' .modal-inner-video').html(text);
			break;
