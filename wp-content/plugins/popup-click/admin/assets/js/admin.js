jQuery(document).ready(function($) {
	...
	var tabs = '<h2 class="nav-tab-wrapper" id="cc-pu-tabs"><a class="nav-tab nav-tab-active" href="#" title="Templates" data-target="cc-pu-tab-1"><span class="dashicons dashicons-format-gallery"></span> Templates</a><a class="nav-tab" href="#" title="Settings" data-target="cc-pu-tab-2"><span class="dashicons dashicons-admin-generic"></span> Settings</a></h2>';

	$('#post').prepend(tabs);

	$('#wpbody-content > .wrap').prepend('<a class="button button-secondary right button-hero" style="margin: 25px 0px 0px 2px; padding: 0px 20px; height: 47px;" href="https://shop.chop-chop.org/contact" target="_blank">Contact Support</a><a class="button button-primary right button-hero" href="http://ch-ch.org/popuppro" style="margin: 25px 20px 0 2px;">Get Pro</a>');
