	...
	<tbody>
		<tr class="cmb-type-radio">
			...
			<td>
				...
				<br /> <span class="cmb_metabox_description">Enter the .class or #id of the element that should trigger the pop-up.<br>Need help? Refer to "Triggers" in the <a href="http://ch-ch.org/popups" target="_blank">Documentation</a>.</span>
			</td>
		</tr>
	</tbody>
</table>
