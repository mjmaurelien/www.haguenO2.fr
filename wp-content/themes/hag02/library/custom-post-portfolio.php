...
function portfolio_posts_type(){
  $labels_portfolio_post_type_array = array(
            'name'                  =>  __('Offres', 'haguen02'),
            'singular_name'         =>  __('Offres', 'haguen02'),
            'add_new'               =>  __('Ajouter une offres', 'haguen02'),
            'add_new_item'          =>  __('Ajouter une offres', 'haguen02'),
            'edit_item'             =>  __('Editer l\'offres', 'haguen02'),
            'new_item'              =>  __('Nouvelle astuce', 'haguen02'),
            'view_item'             =>  __('Visualiser l\'offres', 'haguen02'),
            'search_items'          =>  __('Rechercher une offres', 'haguen02'),
            'not_found'             =>  __('Aucune offres', 'haguen02'),
            'not_found_in_trash'    =>  __('Aucune offres dans la corbeille', 'haguen02'),
